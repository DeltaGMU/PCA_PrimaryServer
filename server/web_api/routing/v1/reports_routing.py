...
from server.lib.data_classes.report import PydanticRetrieveEmployeeReport, PydanticDeleteEmployeeReport
from server.lib.report_generation.report_generator import create_time_sheets_report, delete_time_sheet_report_from_date
...
class ReportsRouter:
    ...
    class Create:
        ...
        async def create_time_sheets_report(reporting_period: PydanticRetrieveEmployeeReport, token: str = Depends(oauth_scheme), session=Depends(get_db_session)):
            """
